dotnet pack ./DWIS.API.DTO/DWIS.API.DTO.csproj --output reference-implementation-packages -p:PackageVersion=2.1.21 --version-suffix "dev"
dotnet pack ./DWIS.OPCUA.Schemas/DWIS.OPCUA.Schemas.csproj --output reference-implementation-packages -p:PackageVersion=2.1.21  --version-suffix "dev"
